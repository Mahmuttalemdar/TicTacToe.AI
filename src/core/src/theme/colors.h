...
class Colors : public QObject
{
    ...
    // Header
    Q_PROPERTY(
      QString mainHeaderBackground READ mainHeaderBackground WRITE setMainHeaderBackground NOTIFY mainHeaderBackgroundChanged)
    Q_PROPERTY(
      QString subHeaderBackground READ subHeaderBackground WRITE setSubHeaderBackground NOTIFY subHeaderBackgroundChanged)
    ...
    Q_PROPERTY(
      QString textFieldPlaceholder READ textFieldPlaceholder WRITE setTextFieldPlaceholder NOTIFY textFieldPlaceholderChanged)
    Q_PROPERTY(QString text READ text WRITE setText NOTIFY textChanged)
    ...
    Q_PROPERTY(QString textAreaSelectionColor READ textAreaSelectionColor WRITE setTextAreaSelectionColor NOTIFY
                 textAreaSelectionColorChanged)
    Q_PROPERTY(
      QString textAreaSelectedColor READ textAreaSelectedColor WRITE setTextAreaSelectedColor NOTIFY textAreaSelectedColorChanged)
    ...
    Q_PROPERTY(QString userSwitchButtonEnabled READ userSwitchButtonEnabled WRITE setUserSwitchButtonEnabled NOTIFY
                 userSwitchButtonEnabledChanged)
    ...
    Q_PROPERTY(
      QString userDeleteButtonText READ userDeleteButtonText WRITE setUserDeleteButtonText NOTIFY userDeleteButtonTextChanged)
    ...
    Q_PROPERTY(QString addUserButtonTextHover READ addUserButtonTextHover WRITE setAddUserButtonTextHover NOTIFY
                 addUserButtonTextHoverChanged)
    ...
    Q_PROPERTY(
      QString textButtonBackground READ textButtonBackground WRITE setTextButtonBackground NOTIFY textButtonBackgroundChanged)
    Q_PROPERTY(
      QString popupButtonBackground READ popupButtonBackground WRITE setPopupButtonBackground NOTIFY popupButtonBackgroundChanged)
    Q_PROPERTY(QString popupButtonHoverBackground READ popupButtonHoverBackground WRITE setPopupButtonHoverBackground NOTIFY
                 popupButtonHoverBackgroundChanged)
    ...
    Q_PROPERTY(
      QString popupButtonTextHover READ popupButtonTextHover WRITE setPopupButtonTextHover NOTIFY popupButtonTextHoverChanged)
    ...
    Q_PROPERTY(QString settingsSidebarBackground READ settingsSidebarBackground WRITE setSettingsSidebarBackground NOTIFY
                 settingsSidebarBackgroundChanged)
    Q_PROPERTY(QString settingsPanelBackground READ settingsPanelBackground WRITE setSettingsPanelBackground NOTIFY
                 settingsPanelBackgroundChanged)
    Q_PROPERTY(QString settingsPanelText READ settingsPanelText WRITE setSettingsPanelText NOTIFY settingsPanelTextChanged)
    Q_PROPERTY(QString settingsPanelTextField READ settingsPanelTextField WRITE setSettingsPanelTextField NOTIFY
                 settingsPanelTextFieldChanged)
    ...
    Q_PROPERTY(
      QString navbarTextCheckable READ navbarTextCheckable WRITE setNavbarTextCheckable NOTIFY navbarTextCheckableChanged)
    ...
    Q_PROPERTY(
      QString languageTextSelected READ languageTextSelected WRITE setLanguageTextSelected NOTIFY languageTextSelectedChanged)
    ...
    Q_PROPERTY(QString delegateSelectedBackground READ delegateSelectedBackground WRITE setDelegateSelectedBackground NOTIFY
                 delegateSelectedBackgroundChanged)
    Q_PROPERTY(QString delegateHoveredBackground READ delegateHoveredBackground WRITE setDelegateHoveredBackground NOTIFY
                 delegateHoveredBackgroundChanged)

    Q_PROPERTY(QString delegateText READ delegateText WRITE setDelegateText NOTIFY delegateTextChanged)
    Q_PROPERTY(
      QString delegateSelectedText READ delegateSelectedText WRITE setDelegateSelectedText NOTIFY delegateSelectedTextChanged)
    Q_PROPERTY(
      QString delegateHoveredText READ delegateHoveredText WRITE setDelegateHoveredText NOTIFY delegateHoveredTextChanged)
    ...
    // StartScreen
    Q_PROPERTY(
      QString startScreenBackground READ startScreenBackground WRITE setStartScreenBackground NOTIFY startScreenBackgroundChanged)
    Q_PROPERTY(
      QString startScreenHeaderText READ startScreenHeaderText WRITE setStartScreenHeaderText NOTIFY startScreenHeaderTextChanged)

    Q_PROPERTY(QString activityItemBackground READ activityItemBackground WRITE setActivityItemBackground NOTIFY
                 activityItemBackgroundChanged)
    ...
    Q_PROPERTY(QString newActivityButtonBackground READ newActivityButtonBackground WRITE setNewActivityButtonBackground NOTIFY
                 newActivityButtonBackgroundChanged)
    Q_PROPERTY(
      QString newActivityButtonText READ newActivityButtonText WRITE setNewActivityButtonText NOTIFY newActivityButtonTextChanged)

    // Activity Area
    Q_PROPERTY(QString activitySidebarBackground READ activitySidebarBackground WRITE setActivitySidebarBackground NOTIFY
                 activitySidebarBackgroundChanged)

    // Search Field
    Q_PROPERTY(
      QString searchFieldBackground READ searchFieldBackground WRITE setSearchFieldBackground NOTIFY searchFieldBackgroundChanged)
    Q_PROPERTY(QString searchFieldBackground2 READ searchFieldBackground2 WRITE setSearchFieldBackground2 NOTIFY
                 searchFieldBackground2Changed)
    ...
    Q_PROPERTY(
      QString searchFieldIconHover READ searchFieldIconHover WRITE setSearchFieldIconHover NOTIFY searchFieldIconHoverChanged)

    // New Activity Popup
    Q_PROPERTY(QString newActivityPopupBackground READ newActivityPopupBackground WRITE setNewActivityPopupBackground NOTIFY
                 newActivityPopupBackgroundChanged)
    Q_PROPERTY(QString newActivityPopupHeaderText READ newActivityPopupHeaderText WRITE setNewActivityPopupHeaderText NOTIFY
                 newActivityPopupHeaderTextChanged)

    // Activity Area
    Q_PROPERTY(QString activityAreaBackground READ activityAreaBackground WRITE setActivityAreaBackground NOTIFY
                 activityAreaBackgroundChanged)

    // Chat Section
    Q_PROPERTY(
      QString chatSectionBackground READ chatSectionBackground WRITE setChatSectionBackground NOTIFY chatSectionBackgroundChanged)
    ...
    // Chat Bubble
    Q_PROPERTY(QString chatBubbleBackgroundIn READ chatBubbleBackgroundIn WRITE setChatBubbleBackgroundIn NOTIFY
                 chatBubbleBackgroundInChanged)
    Q_PROPERTY(QString chatBubbleBackgroundOut READ chatBubbleBackgroundOut WRITE setChatBubbleBackgroundOut NOTIFY
                 chatBubbleBackgroundOutChanged)
    ...
    Q_PROPERTY(
      QString chatBubbleDateTextIn READ chatBubbleDateTextIn WRITE setChatBubbleDateTextIn NOTIFY chatBubbleDateTextInChanged)
    Q_PROPERTY(
      QString chatBubbleDateTextOut READ chatBubbleDateTextOut WRITE setChatBubbleDateTextOut NOTIFY chatBubbleDateTextOutChanged)

    Q_PROPERTY(
      QString chatBubbleMediaTextIn READ chatBubbleMediaTextIn WRITE setChatBubbleMediaTextIn NOTIFY chatBubbleMediaTextInChanged)
    Q_PROPERTY(QString chatBubbleMediaTextOut READ chatBubbleMediaTextOut WRITE setChatBubbleMediaTextOut NOTIFY
                 chatBubbleMediaTextOutChanged)
    ...
    Q_PROPERTY(QString chatBubbleMediaBackground READ chatBubbleMediaBackground WRITE setChatBubbleMediaBackground NOTIFY
                 chatBubbleMediaBackgroundChanged)

    Q_PROPERTY(QString chatBubbleSignatureText READ chatBubbleSignatureText WRITE setChatBubbleSignatureText NOTIFY
                 chatBubbleSignatureTextChanged)
    Q_PROPERTY(QString chatBubbleSignatureTextSigning READ chatBubbleSignatureTextSigning WRITE setChatBubbleSignatureTextSigning
                 NOTIFY chatBubbleSignatureTextSigningChanged)
    Q_PROPERTY(QString chatBubbleSignatureTextRejected READ chatBubbleSignatureTextRejected WRITE
                 setChatBubbleSignatureTextRejected NOTIFY chatBubbleSignatureTextRejectedChanged)

    // Chat Footerbar
    Q_PROPERTY(
      QString chatFooterBackground READ chatFooterBackground WRITE setChatFooterBackground NOTIFY chatFooterBackgroundChanged)
    Q_PROPERTY(QString chatFooterText READ chatFooterText WRITE setChatFooterText NOTIFY chatFooterTextChanged)
    Q_PROPERTY(QString chatFooterTextBackground READ chatFooterTextBackground WRITE setChatFooterTextBackground NOTIFY
                 chatFooterTextBackgroundChanged)

    // Transaction Progressbar
    Q_PROPERTY(QString transactionProgressBarBackground READ transactionProgressBarBackground WRITE
                 setTransactionProgressBarBackground NOTIFY transactionProgressBarBackgroundChanged)
    ...
    Q_PROPERTY(
      QString colorAccentHoverBlue READ colorAccentHoverBlue WRITE setColorAccentHoverBlue NOTIFY colorAccentHoverBlueChanged)
    Q_PROPERTY(QString colorAccentMediumHintedBlue READ colorAccentMediumHintedBlue WRITE setColorAccentMediumHintedBlue NOTIFY
                 colorAccentMediumHintedBlueChanged)
    Q_PROPERTY(QString colorAccentMediumHintedRed READ colorAccentMediumHintedRed WRITE setColorAccentMediumHintedRed NOTIFY
                 colorAccentMediumHintedRedChanged)
    Q_PROPERTY(
      QString colorAccentMediumBlue READ colorAccentMediumBlue WRITE setColorAccentMediumBlue NOTIFY colorAccentMediumBlueChanged)
...
public:
    ...
    QString mainBackground() const { return m_mainBackground; }

    QString mainHeaderBackground() const { return m_mainHeaderBackground; }

    QString subHeaderBackground() const { return m_subHeaderBackground; }
    ...
    QString panelBackground() const { return m_panelBackground; }

    QString subHeaderText() const { return m_subHeaderText; }

    QString textField() const { return m_textField; }

    QString textFieldEnabled() const { return m_textFieldEnabled; }

    QString textFieldFocus() const { return m_textFieldFocus; }

    QString textFieldText() const { return m_textFieldText; }

    QString textFieldSelection() const { return m_textFieldSelection; }

    QString textFieldPlaceholder() const { return m_textFieldPlaceholder; }

    QString userSwitchButton() const { return m_userSwitchButton; }

    QString userSwitchButtonEnabled() const { return m_userSwitchButtonEnabled; }

    QString linkButton() const { return m_linkButton; }

    QString backButton() const { return m_backButton; }

    QString backButtonEnabled() const { return m_backButtonEnabled; }

    QString settingsSidebarBackground() const { return m_settingsSidebarBackground; }

    QString navbarBackground() const { return m_navbarBackground; }

    QString navbarBackground2() const { return m_navbarBackground2; }

    QString navbarText() const { return m_navbarText; }

    QString navbarText2() const { return m_navbarText2; }

    QString navbarTextChecked() const { return m_navbarTextChecked; }

    QString navbarTextCheckable() const { return m_navbarTextCheckable; }

    QString navbarChecked() const { return m_navbarChecked; }

    QString navbarHover() const { return m_navbarHover; }

    QString navbarEnabled() const { return m_navbarEnabled; }

    QString contactUserName() const { return m_contactUserName; }

    QString contactEcoId() const { return m_contactEcoId; }

    QString loginText() const { return m_loginText; }

    QString delegateBackground() const { return m_delegateBackground; }

    QString delegateText() const { return m_delegateText; }

    QString lastMessageColor() const { return m_lastMessageColor; }

    QString lastMessageColor2() const { return m_lastMessageColor2; }

    QString delegateSelectedBackground() const { return m_delegateSelectedBackground; }

    QString delegateHoveredBackground() const { return m_delegateHoveredBackground; }

    QString delegateSelectedText() const { return m_delegateSelectedText; }

    QString delegateHoveredText() const { return m_delegateHoveredText; }

    QString userDeleteButton() const { return m_userDeleteButton; }

    QString userDeleteButtonText() const { return m_userDeleteButtonText; }

    QString addUserButton() const { return m_addUserButton; }

    QString addUserButtonText() const { return m_addUserButtonText; }

    QString addUserButtonTextHover() const { return m_addUserButtonTextHover; }

    QString addUserButtonHover() const { return m_addUserButtonHover; }

    QString settingsBackground() const { return m_settingsBackground; }

    QString settingsPanelBackground() const { return m_settingsPanelBackground; }

    QString settingsPanelText() const { return m_settingsPanelText; }

    QString settingsPanelTextField() const { return m_settingsPanelTextField; }

    QString languageBackground() const { return m_languageBackground; }

    QString languageSelection() const { return m_languageSelection; }

    QString languageText() const { return m_languageText; }

    QString languageTextSelected() const { return m_languageTextSelected; }

    QString infoText() const { return m_infoText; }

    QString infoHeaderText() const { return m_infoHeaderText; }

    QString infoSubHeaderText() const { return m_infoSubHeaderText; }

    QString textAreaSelectionColor() const { return m_textAreaSelectionColor; }

    QString textAreaSelectedColor() const { return m_textAreaSelectedColor; }

    QString startScreenBackground() const { return m_startScreenBackground; }

    QString startScreenHeaderText() const { return m_startScreenHeaderText; }

    QString activityItemBackground() const { return m_activityItemBackground; }

    QString activityItemText() const { return m_activityItemText; }

    QString newActivityButton() const { return m_newActivityButton; }

    QString newActivityButtonBackground() const { return m_newActivityButtonBackground; }

    QString newActivityButtonText() const { return m_newActivityButtonText; }

    QString activitySidebarBackground() const { return m_activitySidebarBackground; }

    QString searchFieldBackground() const { return m_searchFieldBackground; }

    QString searchFieldText() const { return m_searchFieldText; }

    QString searchFieldIcon() const { return m_searchFieldIcon; }

    QString searchFieldIconHover() const { return m_searchFieldIconHover; }

    QString searchFieldBackground2() const { return m_searchFieldBackground2; }

    QString newActivityPopupBackground() const { return m_newActivityPopupBackground; }

    QString newActivityPopupHeaderText() const { return m_newActivityPopupHeaderText; }

    QString textButton() const { return m_textButton; }

    QString textButtonHinted() const { return m_textButtonHinted; }

    QString textButtonEnabled() const { return m_textButtonEnabled; }

    QString textButtonBackground() const { return m_textButtonBackground; }

    QString activityAreaBackground() const { return m_activityAreaBackground; }

    QString chatSectionBackground() const { return m_chatSectionBackground; }

    QString chatSectionLine() const { return m_chatSectionLine; }

    QString chatSectionText() const { return m_chatSectionText; }

    QString chatBubbleBackgroundIn() const { return m_chatBubbleBackgroundIn; }

    QString chatBubbleBackgroundOut() const { return m_chatBubbleBackgroundOut; }

    QString dropShadow4() const { return m_dropShadow4; }

    QString chatBubbleMediaIcon() const { return m_chatBubbleMediaIcon; }

    QString chatBubbleMediaBackground() const { return m_chatBubbleMediaBackground; }

    QString chatBubbleTextIn() const { return m_chatBubbleTextIn; }

    QString chatBubbleTextOut() const { return m_chatBubbleTextOut; }

    QString chatBubbleDateTextIn() const { return m_chatBubbleDateTextIn; }

    QString chatBubbleDateTextOut() const { return m_chatBubbleDateTextOut; }

    QString chatBubbleMediaTextIn() const { return m_chatBubbleMediaTextIn; }

    QString chatBubbleMediaTextOut() const { return m_chatBubbleMediaTextOut; }

    QString chatBubbleSignatureText() const { return m_chatBubbleSignatureText; }

    QString chatBubbleSignatureTextSigning() const { return m_chatBubbleSignatureTextSigning; }

    QString chatBubbleSignatureTextRejected() const { return m_chatBubbleSignatureTextRejected; }

    QString chatFooterBackground() const { return m_chatFooterBackground; }

    QString chatFooterText() const { return m_chatFooterText; }

    QString chatFooterTextBackground() const { return m_chatFooterTextBackground; }

    QString popupButtonBackground() const { return m_popupButtonBackground; }

    QString popupButtonIcon() const { return m_popupButtonIcon; }

    QString popupButtonText() const { return m_popupButtonText; }

    QString transactionProgressBarBackground() const { return m_transactionProgressBarBackground; }

    QString popupButtonHoverBackground() const { return m_popupButtonHoverBackground; }

    QString popupButtonTextHover() const { return m_popupButtonTextHover; }

    QString linkMessageTextIn() const { return m_linkMessageTextIn; }

    QString linkMessageTextOut() const { return m_linkMessageTextOut; }
