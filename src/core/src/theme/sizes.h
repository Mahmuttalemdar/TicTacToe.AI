...
public:
    ...
    int textExtraLarge() const { return m_textExtraLarge; }

    int textLarge() const { return m_textLarge; }

    int textNormal() const { return m_textNormal; }

    int textSmall() const { return m_textSmall; }

    int textExtraSmall() const { return m_textExtraSmall; }

    int searchFieldHeight() const { return m_searchFieldHeight; }
